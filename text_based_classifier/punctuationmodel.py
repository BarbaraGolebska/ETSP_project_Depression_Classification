...
""" 
    We use a punctuation restoration model from deepmultilingualpunctuation,
    which is adapted here to allow for device selection (cpu, cuda, mps).
"""

class PunctuationModel():
    def __init__(self, model = "oliverguhr/fullstop-punctuation-multilang-large", device='cpu') -> None:        
        self.pipe = pipeline("ner", model, grouped_entities=False, device=device)       
